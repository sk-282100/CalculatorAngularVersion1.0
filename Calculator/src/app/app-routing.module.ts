...
export const routingComponents = [RecurringDepositCalculatorComponentComponent,RecurringDepositeClosureCalculatorComponent,HomePageComponent,FixedDepositeCalculatorComponent]